...
export const translations = {
  en: {
    ...
    footer: {
      ...
      contact: 'Contact',
      copyright: '© {{year}} Usama Liaquat. All rights reserved.',
  ...
  tr: {
    ...
    footer: {
      ...
      contact: 'İletişim',
      copyright: '© {{year}} Usama Liaquat. Tüm hakları saklıdır.',
  ...
  it: {
    ...
    footer: {
      ...
      contact: 'Contatti',
      copyright: '© {{year}} Usama Liaquat. Tutti i diritti riservati.',
