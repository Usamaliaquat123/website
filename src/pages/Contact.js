...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact | Usama Liaquat</title>
        <meta name="description" content="Get in touch with Usama Liaquat for project collaborations, consulting, or just to say hello." />
      </Helmet>
