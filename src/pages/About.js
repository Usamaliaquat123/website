...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About | Usama Liaquat</title>
        <meta name="description" content="Learn more about Usama Liaquat, a passionate software engineer specializing in full-stack development and cloud technologies." />
      </Helmet>
